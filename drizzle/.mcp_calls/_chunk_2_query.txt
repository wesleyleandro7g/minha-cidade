INSERT INTO public._seed_migration_staging (part, content) VALUES (2, $c2$.entity_type = 'business'
AND NOT EXISTS (
...
JOIN _seed_ids tt ON tt.fixture_id = 't-salinas' AND tt.entity_type = 'tenant'
WHERE tb.fixture_id = 'b-clinica-vida' AND tb.entity_type = 'business'
AND NOT EXISTS ($c2$) ON CONFLICT (part) DO UPDATE SET content = EXCLUDED.content;