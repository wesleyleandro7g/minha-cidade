INSERT INTO public._seed_migration_staging (part, content) VALUES (7, $c7$-sabor-mineiro' AND tb.entity_type = 'business'
...
COMMIT;$c7$) ON CONFLICT (part) DO UPDATE SET content = EXCLUDED.content;