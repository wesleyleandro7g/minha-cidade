INSERT INTO public._seed_migration_staging (part, content) VALUES (6, $c6$usiness_hours (tenant_id, business_id, weekday, opens_at, closes_at, closed)
...
SELECT tt.db_id, tb.db_id,
  ...
  25
FROM _seed_ids tt
LEFT JOIN _seed_ids tb ON tb.fixture_id = 'b$c6$) ON CONFLICT (part) DO UPDATE SET content = EXCLUDED.content;